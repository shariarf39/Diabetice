...
import 'package:diabetes_self_care_new/activitys/pages/activity/database_ac.dart';
...
class Ac_select extends StatefulWidget {

  @override
  State<Ac_select> createState() => _Medi_selectState();
}

class _Medi_selectState extends State<Ac_select> {
  //
  ...
  void _refreshJournals() async {
    final data = await SQLHelper_ac.getItems();
    setState(() {
      _journals = data;
      _isLoading = false;
    });
...
// Insert a new journal to the database
  ...
  void _deleteItem(int id) async {
    await SQLHelper_ac.deleteItem(id);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(title: const Text("Add Physical Activity"),
          actions: <Widget>[
            IconButton(
              icon: const Icon(
                Icons.close,
